...
interface IDrmManagerService {
    ...
    DrmConstraints[]  getConstraints( int uniqueId, in String[]  path, in int action);
    ...
    DrmInfo[]  acquireDrmInfo(int uniqueId, in DrmInfoRequest[]  drmInforequest);
    void saveRights(int uniqueId, in DrmRights drmRights, String rightsPath, String contentPath);
    ...
    void consumeRights( int uniqueId, in DecryptHandle[]  decryptHandle, int action, boolean reserve);
    void setPlaybackStatus( int uniqueId, in DecryptHandle[]  decryptHandle, int playbackStatus, long position);
    boolean validateAction( int uniqueId, String path, int action, in ActionDescription description);
    ...
    DrmConvertedStatus[]  convertData( int uniqueId, int convertId, in DrmBuffer[]  inputData);
